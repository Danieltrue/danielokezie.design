...
export function addCard() {
    let projects = [
        ...
        },
        {
            ...
            description: "This is a simple ecommerce api which i build recently the project is a part of my current journey, simple post - delete - update - fetch ecommerce product my challenge during the project was my setup and how i miscalculated my development time it took me a week to build the whole thing it was just nice finishing this project.",
